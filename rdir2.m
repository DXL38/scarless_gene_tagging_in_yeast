function [varargout] = rdir2(rootdir,varargin)
...
%
%    The rdir funciton was developed by Gus Brown (April 11 2008) 
%    and the m-file can be downloaded from the MathWorks file exchange
%    website at 
